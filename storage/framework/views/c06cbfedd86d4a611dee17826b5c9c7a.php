...
<?php $__env->startSection('title', 'Book Appointment - Altoz BarberShop'); ?>
            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-4">
                        <a href="<?php echo e(route('booking.quick')); ?>" class="btn btn-success btn-lg rounded-pill px-5 py-3 shadow-sm">
                    ...
                    <!-- Booking Form -->
                    <form action="<?php echo e(route('booking.whatsapp')); ?>" method="POST" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.booking', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\backoffice_haircut\resources\views/pages/booking/index.blade.php ENDPATH**/ ?>