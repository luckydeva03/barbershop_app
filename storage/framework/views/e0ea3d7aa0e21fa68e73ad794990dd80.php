...
<header class="hero">
    <div class="container">
        ...
        <a href="<?php echo e(route('booking.index')); ?>" class="btn btn-lg btn-primary me-2">Book Now</a>
        <a href="<?php echo e(route('stores.index')); ?>" class="btn btn-lg btn-outline-light">Our Stores</a>
    </div>
</header>
...
<section id="about" class="about py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="<?php echo e(asset('images/image1.png')); ?>" alt="About Image">
            </div>
            <div class="col-md-6">
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-3 mb-4">
                <img src="<?php echo e(asset('clients/galeri/1.jpg')); ?>" class="img-fluid rounded" alt="Gallery Image 1">
            </div>
            <div class="col-md-3 mb-4">
                <img src="<?php echo e(asset('clients/galeri/2.jpg')); ?>" class="img-fluid rounded" alt="Gallery Image 2">
            </div>
            <div class="col-md-3 mb-4">
                <img src="<?php echo e(asset('clients/galeri/3.jpg')); ?>" class="img-fluid rounded" alt="Gallery Image 3">
            </div>
            <div class="col-md-3 mb-4">
                <img src="<?php echo e(asset('clients/galeri/4.jpg')); ?>" class="img-fluid rounded" alt="Gallery Image 4">
            </div>
        </div>
...
<?php /**PATH E:\laragon\www\backoffice_haircut\resources\views/pages/home/index.blade.php ENDPATH**/ ?>