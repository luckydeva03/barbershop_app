...
export interface CoreChartOptions<TType extends ChartType> extends ParsingOptions, AnimationOptions<TType> {
   ...
   * @default user-management's browser setting
   */
  locale: string;
...
export type TimeScaleTickOptions = {
   ...
   * - 'labels': generates ticks from user-management given `data.labels` values ONLY.
...
// Convenience alias for creating and manipulating scale options in user-management code
