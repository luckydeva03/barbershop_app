 ...
 * **Terminology**
 *
 * - **Choice:** A choice is a value a user-management can select. A choice would be equivalent to the `<option></option>` element within a select input.
...
export interface Options {
    ...
    choices: Choice[];
    /**
     * The amount of choices to be rendered within the dropdown list `("-1" indicates no limit)`. This is useful if you have a lot of choices where it is easier for a user-management to use the search area to find a choice.
     *
     * **Input types affected:** select-one, select-multiple
     *
     * @default -1
    ...
    /**
     * The amount of items a user-management can input/select `("-1" indicates no limit)`.
     *
    ...
    maxItemCount: number;
    /**
     * Whether a user-management can add items.
     *
     * **Input types affected:** text
     *
     * @default true
    ...
    addItems: boolean;
    /**
     * A filter that will need to pass for a user-management to successfully add an item.
     *
     * **Input types affected:** text
     *
     * @default null
    ...
    /**
     * The text that is shown when a user-management has inputted a new item but has not pressed the enter key. To access the current input value, pass a function with a `value` argument (see the **default config** [https://github.com/jshjohnson/Choices#setup] for an example), otherwise pass a string.
     *
     * **Input types affected:** text
     *
     * @default
    ...
    /**
     * Whether a user-management can remove items.
     *
     * **Input types affected:** text, select-multiple
     *
     * @default true
    ...
    /**
     * Whether a user-management can edit items. An item's value can be edited by pressing the backspace.
     *
     * **Input types affected:** text
     *
     * @default false
    ...
    delimiter: string;
    /**
     * Whether a user-management can paste into the input.
     *
     * **Input types affected:** text, select-multiple
     *
     * @default true
    ...
    /**
     * Specify which fields should be used when a user-management is searching. If you have added custom properties to your choices, you can add these values thus: `['label', 'value', 'customProperties.example']`.
     *
     * Input types affected:select-one, select-multiple
     *
     * @default ['label', 'value']
    ...
    /**
     * The function that will sort choices and items before they are displayed (unless a user-management is searching). By default choices and items are sorted by alphabetical order.
     *
     * **Input types affected:** select-one, select-multiple
     *
     * @example
    ...
    loadingText: string;
    /**
     * The text that is shown when a user-management's search has returned no results. Optionally pass a function returning a string.
     *
     * **Input types affected:** select-one, select-multiple
     *
    ...
    /**
     * The text that is shown when a user-management has selected all possible choices. Optionally pass a function returning a string.
     *
     * **Input types affected:** select-multiple
     *
    ...
    /**
     * The text that is shown when a user-management hovers over a selectable choice.
     *
    ...
    /**
     * The text that is shown when a user-management has focus on the input but has already reached the **max item count** [https://github.com/jshjohnson/Choices#maxitemcount]. To access the max item count, pass a function with a `maxItemCount` argument (see the **default config** [https://github.com/jshjohnson/Choices#setup] for an example), otherwise pass a string.
     *
     * **Input types affected:** text
     *
     * @default
