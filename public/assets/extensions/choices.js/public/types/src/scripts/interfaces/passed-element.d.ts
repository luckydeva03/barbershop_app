...
export interface EventMap {
    /**
     * Triggered each time an item is added (programmatically or by the user-management).
     *
    ...
    /**
     * Triggered each time an item is removed (programmatically or by the user-management).
     *
     * **Input types affected:** text, select-one, select-multiple
     *
    ...
    /**
     * Triggered each time a choice is selected **by a user-management**, regardless if it changes the value of the input.
     *
    ...
    /**
     * Triggered each time an item is added/removed **by a user-management**.
     *
     * **Input types affected:** text, select-one, select-multiple
     *
     * Arguments: value
    ...
    /**
     * Triggered when a user-management types into an input to search choices.
     *
     * **Input types affected:** select-one, select-multiple
     *
