...
@section('title', $store['name'] . ' - Altoz BarberShop')
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="card-body p-5 h-100 d-flex flex-column justify-content-center">
                            <h1 class="display-6 fw-bold text-primary mb-3">{{ $store['name'] }}</h1>
                            <p class="lead text-muted mb-4">{{ $store['description'] }}</p>
                            ...
                            <div class="store-details">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">{{ $store['hours'] }}</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="d-flex gap-3">
                                <a href="{{ route('booking.index') }}" class="btn btn-primary btn-lg px-4">
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5 text-center">
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="col-auto">
                            <a href="tel:{{ $store['phone'] }}" class="btn btn-outline-success btn-lg">
                                <i class="bi bi-telephone me-2"></i>
                                Call Now
                            </a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('booking.quick') }}" class="btn btn-success btn-lg">
